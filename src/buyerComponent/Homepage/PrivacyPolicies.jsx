...
const PrivacyPolicies = () => {
  ...
  <p>
    ...
    visitors based upon their visit to [YOUR SITE URL] and other sites on the
    Internet. <br />
  ...
  <p>
    <em>
      While each of these advertising partners has their own Privacy Policy for
      their site, an updated and hyperlinked resource is maintained here:{" "}
      ...
      advertising partners of [YOUR SITE URL].
    </em>
  </p>
  <p>
    {" "}
    These third-party ad servers or ad networks use technology in their
    respective advertisements and links that appear on [YOUR SITE URL] and which
    are sent directly to your browser. They automatically receive your IP
    address when this occurs. Other technologies (such as cookies, JavaScript,
    or Web Beacons) may also be used by our site's third-party ad networks to
    measure the effectiveness of their advertising campaigns and/or to
    personalize the advertising content that you see on the site.{" "}
  </p>
  <p>
    {" "}
    [YOUR SITE URL] has no access to or control over these cookies that are used
  ...
  <p>
    ...
    instructions about how to opt-out of certain practices. [YOUR SITE URL]'s
